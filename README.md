...
- Desktop control panels provide presets for Codex, Claude, Grok, OpenCode, AtomCode, and Kimi Code; host configuration controls whether ACP is enabled and which adapter is selected.
